 ...
 * @uses Walker
 */
class AK_Nav_Walker extends Walker {
  /**
  ...
  public function start_lvl( &$output, $depth = 0, $args = array() ) {
    ...
    $output .= "\n$indent<a href=\"#\" role=\"button\" class=\"overlay-close\">Close</a>";
  }
  ...
  public function end_lvl( &$output, $depth = 0, $args = array() ) {
    $indent = str_repeat("\t", $depth);
    // close secondary nav first; overlay div second.
    $output .= "$indent</ul>\n$indent</nav>\n$indent</div>\n";
  }
